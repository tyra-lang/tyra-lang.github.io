/* @ts-self-types="./tyra_wasm.d.ts" */

/**
 * Return a JSON array of bundled stdlib module names (for Playground UI hints).
 * @returns {string}
 */
export function bundled_modules() {
    let deferred1_0;
    let deferred1_1;
    try {
        const ret = wasm.bundled_modules();
        deferred1_0 = ret[0];
        deferred1_1 = ret[1];
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('tyra_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
